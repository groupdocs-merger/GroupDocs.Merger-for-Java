...
This package contains [examples](https://github.com/groupdocs-merger/GroupDocs.Merger-for-Java/tree/master/Examples) that will help you in understanding the API's working and writing your own applications.

GroupDocs.Merger for Java is a cross-platform class library that empowers your applications with file merge features. GroupDocs.Merger supports most of the popular document formats such as PDF, DOCX, XLSX, PPTX, EPUB and others. By using GroupDocs.Merger for Java you can merge multiple files into one file, split single file into several files, reorder, rotate, remove document pages and more. This [Examples](https://github.com/groupdocs-merger/GroupDocs.Merger-for-Java/tree/master/Examples) will help you get started with integrating merger features into your Java applications.
...
2. Clone (using command `git clone https://github.com/groupdocs-merger/GroupDocs.Merger-for-Java.git`) or download the repository from GitHub.
...
3. Locate the `com.groupdocs.examples.merger` package and navigate to its contents.
...
3. Locate the `com.groupdocs.examples.merger` package in `src/test/java` directory and navigate to its contents.
...
The `com.groupdocs.examples.merger.utils.LicenseUtils#createLicenseStream()` method creates a license input stream by searching for a valid license file from various predefined locations.
...
+ **Product API:** [API of GroupDocs.Merger for Java](https://reference.groupdocs.com/merger/java/)
+ **Download:** [Download GroupDocs.Merger for Java](https://releases.groupdocs.com/merger/java/)
+ **Documentation:** [GroupDocs.Merger for Java Documentation](https://docs.groupdocs.com/merger/java/)
+ **Forum:** [GroupDocs.Merger for Java Forum](https://forum.groupdocs.com/c/merger/32)
+ **Blog:** [GroupDocs.Merger for Java Blog](https://blog.groupdocs.com/categories/groupdocs.merger-product-family/)
